...
export default function LoginPage() {
  ...
  const handleCelebrityLogin = () => {
    setEmail('celebrity@starconnect.com');
    setPassword('celebrity123');
  };

  const handlePublicLogin = () => {
    setEmail('public@starconnect.com');
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-semibold py-2 px-4 rounded-lg transition-all duration-200 text-sm"
              >
                Login as Celebrity
              </button>
              <button
                ...
                className="flex-1 bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700 text-white font-semibold py-2 px-4 rounded-lg transition-all duration-200 text-sm"
              >
                Login as Public
              </button>
            </div>
